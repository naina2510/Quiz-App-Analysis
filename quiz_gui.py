...
class SoundManager:
    ...
    def play(self, sound_type):
        if self.use_pygame:
            try:
                if sound_type == "click" and os.path.exists("click.wav"): pygame.mixer.Sound("click.wav").play()
                elif sound_type == "correct" and os.path.exists("correct.wav"): pygame.mixer.Sound("correct.wav").play()
                elif sound_type == "wrong" and os.path.exists("wrong.wav"): pygame.mixer.Sound("wrong.wav").play()
                return
            except: pass
        
        try:
            import winsound
            if sound_type == "correct": winsound.Beep(1000, 200)
            elif sound_type == "wrong": winsound.Beep(400, 400)
            elif sound_type == "click": winsound.Beep(600, 50)
        except: pass
# POPUP: ADD ADMIN
